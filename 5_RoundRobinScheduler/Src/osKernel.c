...
/* When an exception occurs these registers are automatically
 * saved on to the stack : r0,r1,r2,r3,r12,lr,pc,psr
 * The function below isnt ever called by any of the code I have wrote
 * but its is invoked when a particular interrup occurs*/
